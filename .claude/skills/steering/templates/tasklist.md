...
### ドキュメント更新候補
- {doc-enricher に渡すべき知識の候補。実装中に「これ README に書いておけばよかった」と感じた箇所}

### スキル更新提案
- {steering / doc-enricher / tasklist-executor など既存スキルへの改善提案}
- {今回の実装で「スキルのここがズレていた」と感じた箇所}

### 新規スキル・サブエージェント提案
- {今回の作業を通じて「これ専用のスキル/サブエージェントがあると良かった」と感じた候補}
- {提案の背景・なぜ役立つか}
