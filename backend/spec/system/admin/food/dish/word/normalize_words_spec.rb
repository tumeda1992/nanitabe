...
RSpec.describe "Admin::Food::Dish::Word::NormalizeWords", type: :system do
  ...
  describe "一覧表示" do
    it "既存のNormalizeWordが一覧に表示される" do
      NormalizeWord.create!(entered_source: "test1", entered_destination: "", source: "test1", destination: "test1")
      NormalizeWord.create!(entered_source: "test2", entered_destination: "", source: "test2", destination: "test2")
  ...
  describe "削除フロー" do
    it "「削除」→ 確認 → 一覧から削除" do
      NormalizeWord.create!(entered_source: "delete_test", entered_destination: "", source: "delete_test", destination: "delete_test")
