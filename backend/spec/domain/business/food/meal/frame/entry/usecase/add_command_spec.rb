...
RSpec.describe Business::Food::Meal::Frame::Entry::Usecase::AddCommand do
  let(:user_record) { find_or_create_user }
  let!(:meal_frame) { MealFrame.create!(user: user_record, name: "週末枠") }

  describe "#call" do
    context "with valid parameters" do
      it "creates a new meal frame entry and returns Business::Food::Meal::Frame::Entry::Root" do
