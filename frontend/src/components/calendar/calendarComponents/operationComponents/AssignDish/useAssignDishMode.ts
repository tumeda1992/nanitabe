...
const useOnlyAssigningDishMode = (args: {
  ...
  const inAssigningDishMode = Object.keys(ASSIGNING_DISH_MODES).some(
    (assigningDishMode) => calendarMode === assigningDishMode,
  );

  const isChoosingDishMode =
    calendarMode === ASSIGNING_DISH_MODES.CHOOSING_DISH_MODE;
  const changeCalendarModeToChoosingDishMode = () => {
    updateCalendarMode(ASSIGNING_DISH_MODES.CHOOSING_DISH_MODE);
  };
  ...
  const isAssigningSelectedDishMode =
    calendarMode === ASSIGNING_DISH_MODES.ASSIGNING_SELECTED_DISH_MODE;
  const changeCalendarModeToAssigningSelectedDishMode = () => {
    updateCalendarMode(ASSIGNING_DISH_MODES.ASSIGNING_SELECTED_DISH_MODE);
  };
  ...
  return {
    ...
    isChoosingDishMode,
    changeCalendarModeToChoosingDishMode,
